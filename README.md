...
This README covers how to run the FastAPI backend locally, and how to troubleshoot the most common issue: the app hanging on startup because it can't reach the Azure PostgreSQL database.
